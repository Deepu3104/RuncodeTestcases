...
time.sleep(5)
Teams_Name = driver.find_element(By.XPATH,'//*[@id="id_team_name"]')
highlight(Teams_Name,10,"blue",5)
time.sleep(5)
Teams_Name.send_keys("Testing")
time.sleep(5)
Save_button = driver.find_element(By.XPATH,'//*[@id="team_submit"]')
