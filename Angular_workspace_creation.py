...
Angular_workspace = driver.find_element(By.XPATH,'/html/body/section/div/div/div/div[2]/div[2]/div/div[1]')
highlight(Angular_workspace,10,"blue",5)
Angular_workspace.click()
time.sleep(5)
driver.quit
