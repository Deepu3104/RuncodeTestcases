...
Launch_Jupyter = driver.find_element(By.XPATH,'/html/body/section/div/div/div/div[2]/div[2]/div[2]/div[3]/div/a[2]')
highlight(Launch_Jupyter,10,"blue",5)
time.sleep(5)
Launch_Jupyter.click()
time.sleep(30)
driver.quit()
