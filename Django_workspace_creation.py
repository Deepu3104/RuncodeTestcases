...
Django_workspace = driver.find_element(By.XPATH,'/html/body/section/div/div/div/div[2]/div[2]/div/div[8]')
highlight(Django_workspace,10,"blue",5)
#Django_workspace.click()
time.sleep(30)
driver.quit