...
time.sleep(5)
Bitbucket_login = driver.find_element(By.XPATH,'/html/body/div/div/div/div/div/div/div/a[4]')
highlight(Bitbucket_login,10, "red", 5)
time.sleep(5)
Bitbucket_login.click()
...
time.sleep(10)
continue_button = driver.find_element(By.XPATH,'//*[@id="login-submit"]/span').click()
time.sleep(10)
...
time.sleep(5) 
authorize_button = driver.find_element(By.XPATH,'//*[@id="oauth-authorize"]/section/form/div/div/button[1]').click()
time.sleep(5)
